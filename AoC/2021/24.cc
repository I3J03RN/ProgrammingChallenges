...
uniform_int_distribution<int> Idst(1, 9); 
// values from [a, b) use like Idst(gen);
...
int main() {
  ...
  // just to check, I solved my puzzle input by hand
  cout << check({3, 9, 9, 9, 9, 6, 9, 8, 7, 9, 9, 4, 2, 9}) << endl;
  cout << check({1, 8, 1, 1, 6, 1, 2, 1, 1, 3, 4, 1, 1, 7}) << endl;
